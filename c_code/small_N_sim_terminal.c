...
#define N_ENSEMBLE 250000 //total number of trajectories per batch
#define N_STEPS 40 // the max amount of steps of each trajectory
...
void run_sim(int iteration_thread, int seed, double F){
	...
	int N_array[] = {1, 2, 4, 5, 7, 8, 13, 14, 25, 26, 37, 38};
	int N_array_size = 12;
